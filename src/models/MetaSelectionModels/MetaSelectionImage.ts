...
export class MetaSelectionImage<Config extends MetaSelectionImageConfig = MetaSelectionImageConfig> extends Image {

    metaSelections: Set<Box> = new Set();
    ...
    addBox(box: Box) {
        ...
        (this.editor as MetaSelectionEditor).metaSelectionLayer.add(box)
        this.syncBoxs()
    }
    ...
    syncBoxs() {
        setRecoil(entityListAtom, [...this.metaSelections])
    }
