...
export default function LegendAnnotation({editor, labelMappings, legendState, loader, editorSpacingLeft, uploadRequest, onUploadSubmit}: IProps) {
  ...
  return (
    <>
      ...
      <AnnotationPopup editor={editor} showDirection={true} allowLabelUpdate={true} allowCustomLabels={false}/>
      <LeftSidebar editor={editor} config={{showInput: false,showCheckBoxes: false,showDirection: true, allowLabelUpdate: true}}/>
