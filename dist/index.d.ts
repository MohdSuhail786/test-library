...
declare function useDrawingAreaAnnotator(): [ReactNode, (config: IProps$2) => any, (imImage: IMImage) => Promise<void>, () => any, SetterOrUpdater<LoaderSpinner>];
...
declare function useMetaExtractionAnnotator(): [ReactNode, (config: IProps$1) => any, (imImage: IMImage) => Promise<void>, () => any, SetterOrUpdater<LoaderSpinner>];
...
declare function useLegendAnnotator(): [ReactNode, (config: IProps) => any, (imImage: IMImage) => Promise<void>, () => any, SetterOrUpdater<LoaderSpinner>];
